...
{
    private readonly ElementResource _resource = new ValidElementResource();

    private readonly HashtableSelector _selector = new ValidHashtableSelector();
    ...
    {
        var actual = _selector.Select(_resource);
